...
const feedbacks = [
  {
    quote:
      "This experience completely changed how I guide my daughter. Understanding her native learning style saved us years of academic frustration.",
    name: "Nisha R.",
  ...
  {
    quote:
      "I was hopelessly confused about choosing science versus design. The growth advisor clearly charted my analytical & creative balance.",
    name: "Aman Sen",
  ...
  {
    quote:
      "Highly recommended for any parent or individual seeking to unlock their focus and live a highly purposeful life of confidence.",
    name: "Dr. Sandeep K.",
  ...
  {
    quote:
      "Keyamind's career guidance helped me transition from engineering to management with absolute confidence in my decision-making abilities.",
  ...
  {
    quote:
      "A truly scientific approach to brain development. As an educator, I find their learning style mapping absolutely invaluable for classroom guidance.",
  ...
  {
    quote:
      "Understanding my adversity quotient and emotional triggers helped me manage workplace stress and build healthier relationships.",
  ...
  {
    quote:
      "The detailed analysis of left and right brain dominance helped my teenage son choose architecture over pure science without any hesitation.",
    name: "Muruganandam V.",
    role: "Business Owner",
    location: "Salem",
  },
  {
    quote:
      "Their parenting guidance sessions were an eye-opener. We stopped forcing rote memorization and embraced kinesthetic learning techniques for our daughter.",
  ...
  {
    quote:
      "I finally understand why I thrive in creative environments but struggle with mundane administrative routines. The Ikigai mapping is flawless.",
  ...
  {
    quote:
      "Exceptional counseling and neuroscience insights. It gave my family a completely new vocabulary to understand each other's communication styles.",
  ...
  {
    quote:
      "The corporate leadership mapping helped our startup align co-founders based on executive cognitive strengths. Highly recommended!",
  ...
  {
    quote:
      "My child used to be extremely shy. Keyamind helped us discover her interpersonal strengths, and today she is an active debater in school!",
...
export default function FeedbackMarqueeSection() {
  ...
  return (
    <section
      id="testimonials"
      className="relative overflow-hidden bg-gradient-to-b from-[#FAF5F7] to-[#FAF9F6] py-20 md:py-24 select-none scroll-mt-0 z-10"
    >
      {/* BACKGROUND GLOWS */}
      ...
      <div className="relative z-10 max-w-[1420px] mx-auto px-6 md:px-12 lg:px-16 w-full flex flex-col gap-6 lg:gap-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 lg:gap-10 pb-3 border-b border-dark-lavender/5">
          ...
          >
            Real feedback and life-changing growth stories from parents,
            students, educators, and working professionals across Tamil Nadu.
          </motion.p>
        </div>
      </div>
      ...
      <motion.div
        ...
        viewport={{ once: true, margin: "-50px" }}
        variants={fadeUp}
        className="relative w-full overflow-hidden pt-8 pb-4 flex mask-gradient-horizontal z-10"
      >

        {/* MARQUEE WRAPPER */}
        <div className="flex w-full overflow-hidden hover-pause-marquee">

          {/* LIST 1 */}
          <div className="flex gap-5 sm:gap-6 shrink-0 animate-marquee-reverse-slow pr-5 sm:pr-6">
          ...
          {/* LIST 2 */}
          <div
            className="flex gap-5 sm:gap-6 shrink-0 animate-marquee-reverse-slow pr-5 sm:pr-6"
            aria-hidden="true"
          >
            {feedbacks.map((item, idx) => (
              <div
